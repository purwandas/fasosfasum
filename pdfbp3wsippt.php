...
$query = "select nobast, tglbast, pengembangbast,keterangan from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join lokasidokumen l on b.nobast=l.nobastlokasi where idkategori='1' && bpk357='0' && pulomas='0' && tp3w='1'  order by nobast asc";
...
$pdf->Cell(30,1,'DATA BP3W-NON SIPPT','LRTB',0,'C');

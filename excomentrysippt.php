...
$query = mysql_query("select * from detaildokacuan a inner join dokumenacuan b on a.idkategori=b.idkategori ");
	$no = 1;
	...
	?>
		...
		<td class="center"><a href="excomeditsippt.php?nodokacuan=<?php echo $data['nodokacuan']; ?>">Edit</a></td>
	</tr>

			...
			<div class="box">
				<div class="heading">
					...
					<P align=right><span>
															...
															<tbody>
																...
																while ($data2 = mysql_fetch_array($query2)){
																	...
																	<tr>
																		...
																		<td class="center"><a href="akunedit.php?id=<?php echo $data2['nobast']; ?>">Edit</a>.|.<a href="akunhapus2.php?id=<?php echo $data2['idperuntukan']; ?>" onClick="return konfirmasi()">Hapus</a></td>
																	</tr>
						...
						<div class="content">
							<div class="latest">
								<div class="dashboard-heading">Detail Akun Peruntukan - History</div>
								<div class="dashboard-content">
														...
														<tr>
															...
															<table class="list" id=datatable1 width="1400" border="1" >
																...
																<tbody>
																	...
																	$query9 = mysql_query("select * from akunhistory a inner join peruntukanhistory b on a.idperuntukan=b.idperuntukan where a.idaset='".$data3['idaset']."'") or die(mysql_error());
																	...
																	while ($data9 = mysql_fetch_array($query9)){
																		...
																		<tr>
																			...
																			<td class="left"><?php echo $data9['idperuntukan']; ?></td>
																			
																			<td class="left"><?php echo $data9['deskripsi']; ?></td>
																			<td class="center"><?php echo $data9['kategoriaset']; ?></td>
																			<td class="center"><?php print number_format ($data9['volume']); ?></td>
																			<td class="center"><?php echo $data9['satuan']; ?></td>
																			<td class="center"><?php print number_format  ($data9['nilainjop'],2); ?></td>
																			<td class="center"><?php print number_format  ($data9['jumnjop'],2); ?></td>
																			<td class="center"><?php print number_format  ($data9['nilaibast'],2); ?></td>
																			<td class="center"><?php print number_format  ($data9['nilaimix'],2); ?></td>
																			<td class="right"><?php echo $data9['ketakun']; ?></td>		
									...
									if (isset($_POST['submit'])){
										...
										$check = mysql_query("SELECT nobast FROM akunhistory WHERE nobast = '$nobast'") or die(mysql_error());
...
//simpan data ke database
												$query = mysql_query("INSERT INTO akunhistory VALUES('".$value."','".$_POST['nobast']."','".$tglsql."','".$_POST['idaset']."','".$_POST['kategori'][$key]."','".$_POST['volume'][$key]."','".$_POST['satuan'][$key]."','".$_POST['nilainjop'][$key]."','".$_POST['nilaibast'][$key]."','0','".$_POST['jmlnjop'][$key]."','0','".$_POST['ketakun'][$key]."','".$_POST['total']."','".$_POST['total1']."','".$_POST['total2']."')") or die(mysql_error());

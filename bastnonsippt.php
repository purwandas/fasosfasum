...
<div id="header">
  <div class="div1">
    ...
    <ul class="left" style="display: none;">
      <li id="dashboard"><a href="#" class="top">BAST Gubernur</a></li>
...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" /> BAST Non SIPPT</h1>
...
<a target="_blank" href="excelbastnonsippt.php">
Data per BAST

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastnonsippt2.php">
Data Detail

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastnonsippt129.php">
Kel.129


<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastnonsippt54.php">
Kel.54


<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastnonsippt163.php">
Kel.163


<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastnonsippt101.php">
Kel.101


<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastnonsippt2009.php">
2009


<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastnonsippt2010.php">
2010

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastnonsipptmutasi.php">
Mutasi 2011


<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastnonsippttambah.php">
140 Penambah
  ...
  <div class="latest">
  <div class="dashboard-heading">Data BAST Non SIPPT</div>
...
<?php
	...
	$query = mysql_query("select * from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dokumenacuan c on d.idkategori=c.idkategori where d.idkategori !='1'");

...
<div class="content">
  ...
  <div class="overview">
  <div class="dashboard-heading">Resume Penilaian Kombinasi</div>
  <div class="dashboard-content">
<?php
include "excomkoneksi.php";


$sqlA = "SELECT SUM(nilaimix) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB A' && kel90='1' ";
    	$result = mysql_query($sqlA) or die (mysql_error());
   	 $tA = mysql_fetch_array($result);

$sqlB = "SELECT SUM(nilaimix) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB B' &&  kel90='1' ";
    	$result = mysql_query($sqlB) or die (mysql_error());
   	 $tB = mysql_fetch_array($result);

$sqlC = "SELECT SUM(nilaimix) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB C' &&  kel90='1'";
    	$result = mysql_query($sqlC) or die (mysql_error());
   	 $tC = mysql_fetch_array($result);

$sqlD = "SELECT SUM(nilaimix) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB D' &&  kel90='1' ";
    	$result = mysql_query($sqlD) or die (mysql_error());
   	 $tD = mysql_fetch_array($result);

$sqlE = "SELECT SUM(nilaimix) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB E' &&  kel90='1' ";
...
?>
          ...
          <table>
            <tr>
              ...
              <td> <a target="_blank" href="excompdflaporanakunAmix.php"><?php echo number_format($tA['total_nilaibast'],2);  ?></td>
            </tr>

            <tr>
              <td>Jumlah Nilai KIB B:</td>
              <td> <a target="_blank" href="excompdflaporanakunBmix.php"><?php echo number_format($tB['total_nilaibast'],2);  ?></td>
            </tr>
            <tr>
              <td>Jumlah Nilai KIB C:</td>
               <td> <a target="_blank" href="excompdflaporanakunCmix.php"><?php echo number_format($tC['total_nilaibast'],2);  ?></td>
            </tr>
            <tr>
              <td>Jumlah Nilai KIB D:</td>
               <td> <a target="_blank" href="excompdflaporanakunDmix.php"><?php echo number_format($tD['total_nilaibast'],2);  ?></td>
            </tr>
            <tr>
              <td>Jumlah Nilai KIB E:</td>
               <td> <a target="_blank" href="excompdflaporanakunEmix.php"><?php echo number_format($tE['total_nilaibast'],2);  ?></td>
            </tr>


            <tr>
              <td>Total Nilai :</td>
               <td> <a target="_blank" href="excelexcom.php"><?php echo (number_format(($tA['total_nilaibast'])+($tB['total_nilaibast'])+($tC['total_nilaibast'])+($tD['total_nilaibast'])+($tE['total_nilaibast']),2));  ?></td>
            </tr>
  ...
  <div class="dashboard-content">
	...
	<?php 
	 $no++;
		...
		$sql = "SELECT SUM(nilaimix) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB A' &&  kel90='1' ";
  ...
  <div class="dashboard-content">
	...
	<?php 
	 $no++;
		...
		$sql = "SELECT SUM(nilaimix) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB B' &&  kel90='1' ";
    	$result = mysql_query($sql) or die (mysql_error());
   	 $t = mysql_fetch_array($result);
  ...
  <div class="dashboard-content">
	...
	<?php 
	 $no++;
		...
		$sql = "SELECT SUM(nilaimix) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB C' &&  kel90='1' ";
    	$result = mysql_query($sql) or die (mysql_error());
   	 $t = mysql_fetch_array($result);
  ...
  <div class="dashboard-content">
	...
	$sql = "SELECT SUM(nilaimix) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB D' &&  kel90='1' ";
    	$result = mysql_query($sql) or die (mysql_error());
   	 $t = mysql_fetch_array($result);
  ...
  <div class="dashboard-content">
	...
	$sql = "SELECT SUM(nilaimix) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB E' &&  kel90='1' ";
    	$result = mysql_query($sql) or die (mysql_error());
   	 $t = mysql_fetch_array($result);

...
$query = "SELECT * FROM akun a inner join bast b on a.nobast=b.nobast inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dataaset s on a.nobast=s.nobastaset inner join peruntukan p on a.idperuntukan=p.idperuntukan order by a.nobast ";
...
while ($data = mysql_fetch_array($hasil))
{
  ...
  // menampilkan data nama mahasiswa
   ...
   // menampilkan data nilai
   xlsWriteLabel($noBarisCell,15,$data['keterangan']);

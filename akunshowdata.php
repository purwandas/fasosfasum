														...
														<table class="list" id=datatable1 width="1400" border="1" >
															...
															<thead>
																<tr>
																	...
																	<td class="center">Volx Nilai Pengali (Rp)</td>
															...
															<tbody>
																...
																while ($data2 = mysql_fetch_array($query2)){
																	...
																	<tr>
																		...
																		<td class="center"><?php print number_format  ($data2['nilaiapp'],2); ?></td>
																		<td class="center"><?php print number_format  ($data2['jumapp'],2); ?></td>
																...
																while ($data1 = mysql_fetch_array($query1)){
																	...
																	<thead>
																		<tr>
																			...
																			<td class="left"><?php ?></td>
																			<td class="center"><?php print number_format ($data1['totapp'],2); ?></td>
																			<td class="right"><?php ?></td>		
																			<td class="center"><?php ?></td>
																		</tr>
...
//simpan data ke database
											$query = mysql_query("INSERT INTO akun VALUES('".$value."','".$_POST['nobast']."','".$tglsql."','".$_POST['idaset']."','".$_POST['kategori'][$key]."','".$_POST['volume'][$key]."','".$_POST['satuan'][$key]."','".$_POST['nilainjop'][$key]."','".$_POST['nilaibast'][$key]."','".$_POST['nilaiapp'][$key]."','".$_POST['jmlnjop'][$key]."','".$_POST['jmlapp'][$key]."','".$_POST['ketakun'][$key]."','".$_POST['total']."','".$_POST['total1']."','".$_POST['total2']."')") or die(mysql_error());

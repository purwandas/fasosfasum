...
if(isset($_REQUEST['submit2'])) {
	...
	$query = mysql_query("select * from bast b inner join (select distinct nobastaset, wilayah from dataaset)a on a.nobastaset=b.nobast  where nobast like '%$term%' or pengembangbast like '%$term%'");

}else

$query = mysql_query("select * from bast");
	$no = 1;
	...
	?>
		...
		<td class="center"><a href="akunkonfirmasi.php?id=<?php echo $data['nobast']; ?>">Entry</a>.|.<a href="akunshowdata2.php?id=<?php echo $data['nobast']; ?>">Show</a></td></td>

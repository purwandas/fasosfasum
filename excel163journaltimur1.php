...
$query = "SELECT * FROM akun a left join akunjournal aj on a.idperuntukan = aj.idperuntukan  inner join bast b on a.nobast=b.nobast inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dataaset s on a.idaset=s.idaset inner join peruntukan p on a.idperuntukan=p.idperuntukan inner join lokasidokumen l on a.nobast=l.nobastlokasi   where ((bpk357 ='1'  && rekon129='1') or (bpk357 ='0' && pulomas='1' && rekon129='1') or ((bpk357 ='1'  && rekon129='0' && rekon54='0' && rekon163='1') or (bpk357 ='0' && pulomas='1' && rekon129='0' && rekon54='0' && rekon163='1') or (bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='0' && rekon54='0' && rekon163='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='1' && rekon129='0' && rekon54='0' && rekon163='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='0' && balaikota='1' && rekon129='0' && rekon54='0' && rekon163='1')) && wilayah='Jakarta Timur' && bastdokumen != 'Tidak Ada Perubahan'  order by a.tglbast" ;
...
while ($data = mysql_fetch_array($hasil))
{
  ...
  // menampilkan data nama mahasiswa
   ...
   // menampilkan data nilai
   xlsWriteLabel($noBarisCell,21,($data['nilaimix'])-($data['hnilaimix']));

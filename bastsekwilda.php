...
<div id="header">
  <div class="div1">
    ...
    <ul class="left" style="display: none;">
      <li id="dashboard"><a href="#" class="top">BAST Sekwilda</a></li>
...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" /> BAST Biro Perlengkapan</h1>
    </div>
...
<a target="_blank" href="excelbastwilda.php">
Bast Sekwilda

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastwilda129.php">
Kel.129

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastwilda54.php">
Kel.54

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastwilda163.php">
Kel.163

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastwilda101.php">
Kel.101

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastwilda2009.php">
Kel.2009

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastwilda2010.php">
Kel.2010

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastwildamutasi.php">
Kel.Mutasi2011

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastwildatambah.php">
Kel.140 Penambah

</a></span></P>

  <div class="latest">
  <div class="dashboard-heading">Data BAST Biro Perlengkapan</div>
...
<?php
	...
	$query = mysql_query("select * from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dokumenacuan c on d.idkategori=c.idkategori where keterangan like '%sekwilda%'");

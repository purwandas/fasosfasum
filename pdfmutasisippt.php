...
$query = "select nobast, tglbast, pengembangbast,keterangan from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join lokasidokumen l on b.nobast=l.nobastlokasi where  bpk357='0' && mutasi='1'  && idkategori='1' && pulomas='0' order by nobast asc";
...
$pdf->Cell(30,1,'DATA MUTASI 2011-SIPPT','LRTB',0,'C');

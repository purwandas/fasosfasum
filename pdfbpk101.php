...
$query = "select nobast, tglbast, pengembangbast,keterangan from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join lokasidokumen l on b.nobast=l.nobastlokasi where bpk357 ='1'  && rekon129='0' && rekon54='0' && rekon163='0' && rekon101='1' order by nobast asc";
...
$pdf->Cell(30,1,'DATA LK2010-101','LRTB',0,'C');

...
<h1><img src="../view/image/lockscreen.png" alt="" /> Please enter Administrator login details.</h1>
    </div>
...
<td>Username:<br />
              <input type="text" name="login" value=""  id="login"  style="margin-top: 4px;" />
              <br />
              <br />
              
Password:<br />
              <input type="password" name="password" value=""   id="password"  style="margin-top: 4px;" />
              <br />

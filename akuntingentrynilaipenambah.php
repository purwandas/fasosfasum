...
$("#total3").val(total);
	...
	<br><br>
		<td></td><td><b>Nilai BAST pada Dokumen : </b></td><td><input type='text' name='bastdokumen' id='total2'/></td>
	<br><br>
...
$query = mysql_query("INSERT INTO akun VALUES('".$value."','".$_POST['nobast']."','".$tglsql."','".$_POST['idaset']."','".$_POST['kategori'][$key]."','".$_POST['volume'][$key]."','".$_POST['satuan'][$key]."','".$_POST['nilainjop'][$key]."','".$_POST['nilaibast'][$key]."','".$_POST['nilaimix'][$key]."','0','".$_POST['jmlnjop'][$key]."','0','".$_POST['ketakun'][$key]."','".$_POST['total']."','".$_POST['total1']."','".$_POST['total3']."','".$_POST['total2']."','".$_POST['bastdokumen']."')") or die(mysql_error());

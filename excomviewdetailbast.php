...
Print this page
	...
	?>
		...
		<tr>
		<td>No.BAST </td><td>: </td><td><?php echo $data['nobast']; ?></td><td><a href="excomeditbast.php?id=<?php echo $data['nobast']; ?>">[ Edit ]</a></td>
      ...
      <div class="statistic">
        ...
        <div class="dashboard-content">
  		<table>
		<tr>
		<td>Jenis Acuan </td><td>: </td><td><?php echo $data['idkategori']; ?></td><td><a href="excomeditsippt.php?nodokacuan=<?php echo $data['nodokacuan']; ?>">[ Edit ]</a></td>
		</tr>
...
function konfirmasi(){
	...
	<a  href="excomakunshowdatabpk.php?id=<?php echo $data['nobast']; ?>">Data Akun ....</a></span>
	...
	<br><a href="excomviewdetailbast.php?id=<?php echo $data['nobast']; ?>">Refresh klik disini</a></br>

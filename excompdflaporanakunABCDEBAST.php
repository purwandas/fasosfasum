...
$query = "select nobastlokasi, deskripsi, volume, satuan, nilaibast from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kel90='1'";
...
$pdf->Cell(31,1,'LAPORAN NILAI BAST EXCOM - KIB A,B,C,D & E','LRTB',0,'C');
...
$pdf->Cell(31,1,'TOTAL : Rp. 	136,957,368,270.00','LRTB',0,'R');

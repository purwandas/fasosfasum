...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" />Laporan Penilaian LKPD-129</h1>
	<P align=right><span>
          ...
          <table>
            ...
            <tr>
              <td></br></br>Jumlah BAST:</td>
               <td> <a target="_blank" href="pdflaporanakuntambahE.php"><?php echo $totalrowlkpd129;  ?></a></td>
            </tr>
...
?>
  ...
  <div class="dashboard-content">
	...
	$query2 = mysql_query("select * from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB A' && ((bpk357 ='1'  && rekon129='1') or (bpk357 ='0' && pulomas='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='0' && balaikota='1' && rekon129='1'))") ;
  ...
  <div class="dashboard-content">
	...
	$query2 = mysql_query("select * from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB B' && ((bpk357 ='1'  && rekon129='1') or (bpk357 ='0' && pulomas='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='0' && balaikota='1' && rekon129='1'))") ;
	$no = 1;
	while ($data2 = mysql_fetch_array($query2)){
  ...
  <div class="dashboard-content">
	...
	$query2 = mysql_query("select * from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB C' && ((bpk357 ='1'  && rekon129='1') or (bpk357 ='0' && pulomas='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='0' && balaikota='1' && rekon129='1'))") ;
  ...
  <div class="dashboard-content">
	...
	$query2 = mysql_query("select * from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB D' && ((bpk357 ='1'  && rekon129='1') or (bpk357 ='0' && pulomas='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='0' && balaikota='1' && rekon129='1'))") ;
  ...
  <div class="dashboard-content">
	...
	$query2 = mysql_query("select * from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB E' && ((bpk357 ='1'  && rekon129='1') or (bpk357 ='0' && pulomas='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='1' && rekon129='1') or (bpk357 ='0'  && pulomas='0' && tp3w='0' && dtr='0' && balaikota='1' && rekon129='1'))") ;

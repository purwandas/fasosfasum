...
$query = "SELECT * FROM akun a inner join bast b on a.nobast=b.nobast  inner join detaildokacuan d on b.nodokacuan=d.nodokacuan  inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join peruntukan p on a.idperuntukan=p.idperuntukan  inner join dataaset s on a.idaset=s.idaset


where (bpk357='0' && pulomas='0' && mutasi='1'  &&  perihalbast!='mutasi2009' &&  perihalbast!='mutasi2010') or (bpk357 ='1' && mutasi='1' && perihalbast!='mutasi2009' && perihalbast!='mutasi2010')or (bpk357 ='0'  && mutasi ='1' && pulomas='1' &&  perihalbast!='mutasi2009' &&  perihalbast!='mutasi2010') or (bpk357 ='0' && pulomas='0' && tp3w='1' && mutasi='1' )or(bpk357 ='0' && pulomas='0' && tp3w='0' && dtr='1' && mutasi='1' &&  perihalbast!='mutasi2009' &&  perihalbast!='mutasi2009' ) or (bpk357 ='0' && pulomas='0' && tp3w='0' && dtr='0' && balaikota='1' && mutasi='1') order by a.nobast";
...
while ($data = mysql_fetch_array($hasil))
{
  ...
  // menampilkan data nama mahasiswa
   ...
   xlsWriteNumber($noBarisCell,14,$data['nilaibast']);

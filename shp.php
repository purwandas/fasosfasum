...
<div id="header">
  <div class="div1">
    ...
    <ul class="left" style="display: none;">
      <li id="dashboard"><a href="#" class="top">SHP</a></li>
...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" /> Data SHP</h1>
    </div>
  ...
  <div class="latest">
  <div class="dashboard-heading">Data SHP</div>
...
<?php
	...
	$query = mysql_query("select * from bast b inner join peruntukan p on b.nobast=p.nobast  where jenissertifikat like '%DKI%'");

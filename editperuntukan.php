...
$query = mysql_query("update peruntukan set  deskripsi='$deskripsi',jenis='$jenis',luas='$luas',nokrk='$nokrk',deskripsi='$deskripsi',jenis='$jenis',luas='$luas',nokrk='$nokrk',noimb='$noimb',noblokplan='$noblokplan',sertifikasi='$sertifikasi',pemilik='$pemilik',jenissertifikat='$jenissertifikat',nosertifikat='$nosertifikat',masaberlaku='$masaberlaku',luassertifikat='$luassertifikat',keterangan='$keterangan' where idperuntukan='$id'") or die(mysql_error());

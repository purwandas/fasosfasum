...
$query = "select nobast, tglbast, pengembangbast,keterangan from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join lokasidokumen l on b.nobast=l.nobastlokasi where idkategori!='1' && bpk357='0' && mutasi='0' && pulomas='1' order by nobast asc";
...
$pdf->Cell(30,1,'DATA PULOMAS-NONSIPPT','LRTB',0,'C');

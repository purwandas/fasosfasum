...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" />Sisipkan Nilai Akun</h1>
...
$query7 = mysql_query("select nobast from peruntukan where idperuntukan='$id'") or die(mysql_error());
$data = mysql_fetch_array($query7);
$nobast = $data['nobast'];

$query8 = mysql_query("select totnjop, totbast, totmix from akun where nobast='$nobast'") or die(mysql_error());
$data8 = mysql_fetch_array($query8);
$totnjop = $data8['totnjop'];
$totbast = $data8['totbast'];
$totmix = $data8['totmix'];



	$query = mysql_query("select * from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dataaset a on b.nobast=a.nobastaset where nobast='$nobast'") or die(mysql_error());
...
<div class="content">
	...
	include "koneksi.php";
	$id = $_GET['id'];
	$query3 = mysql_query("select * from dataaset where nobastaset='$nobast'") or die(mysql_error());
	...
	$query2 = mysql_query("select * from peruntukan where idperuntukan='$id' ") or die(mysql_error());
	$no = 1;
	...
	?>
		...
		<td><input type="text"  'text' name='idperuntukan[]' value="<?php echo $data2['idperuntukan']; ?>" ></td>
...
$("#total3").val(total);
	...
	<img alt=" " src="view/image/filemanager/upload.png" border=0></a>
	<a  href="akuntambahperuntukan.php?id=<?php echo $data3['idaset']; ?>">back to tambah peruntukan...</a></span>
...
$query = mysql_query("INSERT INTO akun VALUES('".$value."','".$data['nobast']."','".$tglsql."','".$_POST['idaset']."','".$_POST['kategori'][$key]."','".$_POST['volume'][$key]."','".$_POST['satuan'][$key]."','".$_POST['nilainjop'][$key]."','".$_POST['nilaibast'][$key]."','".$_POST['nilaimix'][$key]."','0','".$_POST['jmlnjop'][$key]."','0','".$_POST['ketakun'][$key]."','".$data8['totnjop']."','".$data8['totbast']."','".$data8['totmix']."','0','0')") or die(mysql_error());
...
echo 'Input data akun berhasil .....';
			...
			$query = mysql_query("insert into loging values('','$user','tambah akun nobast id peruntukan : $id ','$waktu')") or die(mysql_error());

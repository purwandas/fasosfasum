...
$query = "select nobastlokasi, deskripsi, volume, satuan, nilaimix from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB C' && kel90='1'";
...
$pdf->Cell(31,1,'LAPORAN PENILAIAN KOMBINASI EXCOM - KIB C','LRTB',0,'C');
...
$pdf->Cell(31,1,'TOTAL : Rp. 1,476,389,600.00','LRTB',0,'R');

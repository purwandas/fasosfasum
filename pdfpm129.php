...
$query = "select nobast, tglbast, pengembangbast,keterangan from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join lokasidokumen l on b.nobast=l.nobastlokasi where bpk357 ='0' && pulomas='1' && rekon129='1' order by nobast asc";
...
$pdf->Cell(30,1,'DATA PULOMAS-129','LRTB',0,'C');

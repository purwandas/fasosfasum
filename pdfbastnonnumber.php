...
//Queri untuk Menampilkan data
 ...
 $query = "select nobast,tglbast,pengembangbast,keterangan,nodokacuan from bast where nobast like '%non%' order by nobast asc";
...
$pdf->Cell(29,1,'DATA BAST NON NUMBER','LRTB',0,'C');

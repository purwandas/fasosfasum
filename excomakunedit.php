...
if ($query) {
	echo 'input penjelasan berhasil...........';
			...
			$query33 = mysql_query("insert into loging values('','$user','edit penjelasan no bast excom : $id','$waktu')") or die(mysql_error());
}
?>
...
if ($query) {
	...
	echo 'simpan perubahan data bast berhasil...........';
			...
			$waktu = gmdate("Y-m-d H:i:s", time()+60*60*7);
			$user = $_SESSION['SESS_FIRST_NAME'];
			$query34 = mysql_query("insert into loging values('','$user','edit penjelasan no bast excom : $id','$waktu')") or die(mysql_error());
}
...
<div class="content">
	...
	?>
		...
		<td><input type='text' name='nilaimix[]' value="<?php echo $data2['nilaimix']; ?>" class='nilaimix'></td>
...
$query4 = mysql_query("select distinct nobast,totnjop, totbast, totapp, totmix, bastdokumen  from akun where idaset='".$data3['idaset']."'") or die(mysql_error());
...
$query = mysql_query("update akun set idperuntukan='".$value."',nobast='".$_POST['nobast']."',tglbast='".$tglsql."',idaset='".$_POST['idaset']."',kategoriaset='".$_POST['kategori'][$key]."',volume='".$_POST['volume'][$key]."',satuan='".$_POST['satuan'][$key]."',nilainjop='".$_POST['nilainjop'][$key]."',nilaibast='".$_POST['nilaibast'][$key]."',nilaimix='".$_POST['nilaimix'][$key]."', nilaiapp='0',jumnjop='".$_POST['jmlnjop'][$key]."',jumapp='0',ketakun='".$_POST['ketakun'][$key]."',totnjop='".$_POST['total']."',totbast='".$_POST['total1']."',totmix='".$_POST['total3']."', totapp='".$_POST['total2']."',bastdokumen='".$_POST['bastdokumen']."' where idperuntukan='".$value."'") or die(mysql_error()) ;

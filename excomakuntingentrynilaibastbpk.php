...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" />Entry Penilaian</h1>
...
<div class="content">
  ...
  <div class="dashboard-content">
	...
	<input type="checkbox" name="sippt" value="1" <?php if($data4['sippt'] == 1){echo 'checked="checked"';}?>/> Kelompok Data SIPPT<br/></td></br>
	<td><input type="checkbox" name="nonsippt" value="1" <?php if($data4['nonsippt'] == 1){echo 'checked="checked"';}?>/> Kelompok Data Non SIPPT<br/>
	<input type="checkbox" name="sisa27" value="1" <?php if($data4['sisa27'] == 1){echo 'checked="checked"';}?>/> Kelompok Data Sisa 27<br/></br>
	...
	<P align=left><span>
	<a  href="akuntingentrynilaibastbpk.php?id=<?php echo $data['nobast']; ?>" ></li>
	<img alt=" " src="view/image/filemanager/refresh.png" border=0></a>
	<a href="akuntingentrynilaibastbpk.php?id=<?php echo $data['nobast']; ?>">Refresh here...</a></span>
...
<div class="content">
	...
	<a  href="excomakunshowdatabpk.php?id=<?php echo $data['nobast']; ?>">Show result here...</a></span>


	<a  href="entryperuntukan.php?id=<?php echo $data3['idaset']; ?>" ></li>
	<img alt=" " src="view/image/add.png" border=0></a>
	<a  href="excomentryperuntukan.php?id=<?php echo $data3['idaset']; ?>">Tambah Peruntukan..</a></span>
	

	<a  href="excomviewdetailbast.php?id=<?php echo $data3['nobastaset']; ?>" ></li>
	<img alt=" " src="view/image/setting.png" border=0></a>
	<a  href="excomviewdetailbast.php?id=<?php echo $data3['nobastaset']; ?>">Edit Peruntukan..</a></span>
	...
	?>
		...
		<td><select name='satuan[]'><option>m2</option><option>m</option><option>m1</option><option>m3</option><option>unit</option><option>unit</option> <option>titik</option> <option>buah</option></select>
...
$("#total1").val(total);
	...
	<td></td><td><b>Total Nilai PerGub132 : </b></td><td><input type='text' name='total' id='total' required="required"/></td>
	<br><br>
	<td></td><td><b>Total Nilai BAST : </b></td><td><input type='text' name='total1' id='total1' required="required"/></td>
	<br><br>
		<td></td><td><b>Total Nilai Appraisal : </b></td><td><input type='text' name='total2' id='total2' /></td>
	<br><br>
		<td></td><td><b>Total Nilai BAST Dokumen : </b></td><td><input type='text' name='bastdokumen' id='bastdokumen' /></td>
	<br><br>



	<left><input type=submit name="submit" value="Simpan"/></right><td></td><br><br>
...
$query = mysql_query("INSERT INTO akun VALUES('".$value."','".$_POST['nobast']."','".$tglsql."','".$_POST['idaset']."','".$_POST['kategori'][$key]."','".$_POST['volume'][$key]."','".$_POST['satuan'][$key]."','".$_POST['nilainjop'][$key]."','".$_POST['nilaibast'][$key]."','0','".$_POST['jmlnjop'][$key]."','0','".$_POST['ketakun'][$key]."','".$_POST['total']."','".$_POST['total1']."','".$_POST['total2']."','".$_POST['bastdokumen']."')") or die(mysql_error());

...
$query = "select nobastlokasi, deskripsi, volume, satuan, jumnjop from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB B' && kel90='1'";
...
$pdf->Cell(31,1,'LAPORAN PENILAIAN EXCOM - KIB B','LRTB',0,'C');
...
$pdf->Cell(31,1,'TOTAL : Rp. 4,047,842,969.99','LRTB',0,'R');

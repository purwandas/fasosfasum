...
<div id="header">
  <div class="div1">
    ...
    <ul class="left" style="display: none;">
      <li id="dashboard"><a href="#" class="top">Rekon BP3W</a></li>
...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" />Resume BP3W</h1>
    </div>
  ...
  <div class="dashboard-content">
	...
	$hasilbastlk2010= mysql_query("select bpk357 from lokasidokumen where bpk357 ='0' && pulomas='0' && tp3w='1'");
	$totalbastlk2010 = mysql_num_rows($hasilbastlk2010);	

	$hasilbastlk2010sippt= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast inner join detaildokacuan d on b.nodokacuan=d.nodokacuan  where bpk357 ='0' && pulomas='0' && tp3w='1' && idkategori='1'");
	$totalbastlk2010sippt = mysql_num_rows($hasilbastlk2010sippt);

	$hasilbastlk2010nonsippt= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast inner join detaildokacuan d on b.nodokacuan=d.nodokacuan  where bpk357 ='0' && pulomas='0' && tp3w='1' && idkategori!='1'");
	$totalbastlk2010nonsippt = mysql_num_rows($hasilbastlk2010nonsippt);


$hasilbastlk2010129= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='1'");
	$totalbastlk2010129 = mysql_num_rows($hasilbastlk2010129);


$hasilbastlk201054= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='0' && rekon54='1'");
	$totalbastlk201054 = mysql_num_rows($hasilbastlk201054);

$hasilbastlk2010163= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='0' && rekon54='0' && rekon163='1'");
	$totalbastlk2010163 = mysql_num_rows($hasilbastlk2010163);

$hasilbastlk2010101= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='0' && rekon54='0' && rekon163='0' && rekon101='1'");
	$totalbastlk2010101 = mysql_num_rows($hasilbastlk2010101);
	
$hasilbastlk2010mutasi= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where bpk357 ='0' && pulomas='0' && tp3w='1' && mutasi='1'  ");
	$totalbastlk2010mutasi = mysql_num_rows($hasilbastlk2010mutasi);


$hasilbastlk20102009= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where bpk357 ='0' && pulomas='0' && tp3w='1' && rekon129='0' && rekon54='0' && rekon163='0' && rekon101='0'  &&  perihalbast='mutasi2009'");
	$totalbastlk20102009 = mysql_num_rows($hasilbastlk20102009);

$hasilbastlk20102010= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where bpk357 ='0'  && pulomas='0' && tp3w='1' && rekon129='0' && rekon54='0' && rekon163='0' && rekon101='0' && balaikota='0'   && perihalbast='mutasi2010'");
	$totalbastlk20102010 = mysql_num_rows($hasilbastlk20102010);

$hasilbastlk2010tambah= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where bpk357 ='0' && pulomas='0'  &&  rekon101='0' && tp3w='1' && rekon129='0' && rekon54='0' && rekon163='0' && balaikota='0'");
	$totalbastlk2010tambah = mysql_num_rows($hasilbastlk2010tambah);
	?>

          <table>
            <tr>
              <td>Total BAST BP3W:</td>
              <td><a target="_blank" href="pdfbp3w.php"><?php echo $totalbastlk2010 ?></a></td>
            </tr>

            <tr>
              <td>Jumlah BAST BP3W-SIPPT :</td>
              <td><a target="_blank" href="pdfbp3wsippt.php"><?php echo $totalbastlk2010sippt ?></a></td>
            </tr>

            <tr>
              <td>Jumlah BAST BP3W-NONSIPPT :</td>
              <td><a target="_blank" href="pdfbp3wnonsippt.php"><?php echo $totalbastlk2010nonsippt ?></a></a></td>
            </tr>
         
            <tr>
              <td>Jumlah BP3W-129 :</td>
              <td><a target="_blank" href="pdfbp3w129.php"><?php echo $totalbastlk2010129 ?></a></td>
            </tr>

             <tr>
              <td>Jumlah BP3W-54 :</td>
              <td><a target="_blank" href="pdfbp3w54.php"><?php echo $totalbastlk201054 ?></a></td>
            </tr>

             <tr>
              <td>Jumlah BP3W-163 :</td>
              <td><?php echo $totalbastlk2010163 ?></td>
            </tr>
            <tr>
              <td>Jumlah BP3W-101 :</td>
            ...
            <tr>
              ...
              <td><a target="_blank" href="pdfbp3wtambah.php"><?php echo $totalbastlk2010tambah ?></a></td>
            </tr>
...
if(isset($_REQUEST['submit2'])) {
	...
	$query = mysql_query("select * from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dokumenacuan c on d.idkategori=c.idkategori inner join lokasidokumen l on b.nobast=l.nobastlokasi where bpk357='0' && mutasi='0' && pulomas='0' && tp3w='1' && (nobast like '%$term%' or pengembangbast like '%$term%'  or jenisdokumen like '%$term%')");
}else

$query = mysql_query("select * from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dokumenacuan c on d.idkategori=c.idkategori inner join lokasidokumen l on b.nobast=l.nobastlokasi where bpk357='0' && mutasi='0' && pulomas='0' && tp3w='1' order by nobast asc");
	$no = 1;

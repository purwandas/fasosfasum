...
$query = "select nobast, tglbast, pengembangbast,keterangan from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan where idkategori !='1'";
...
$pdf->Cell(33,1,'DATA BAST-NON SIPPT','LRTB',0,'C');

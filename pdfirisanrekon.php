...
//Queri untuk Menampilkan data
 ...
 $query = "select nobast,tglbast,pengembangbast,keterangan,nodokacuan, wilayah from bast b inner join (select distinct nobastaset, wilayah from dataaset)d on b.nobast=d.nobastaset inner join lokasidokumen l on b.nobast=l.nobastlokasi    where rekon163='1' && rekon129='1'  && rekon54='1' && rekon101='1' order by wilayah asc";

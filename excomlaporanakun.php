...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" />Laporan Penilaian Excom</h1>
	<P align=right><span>
...
<div class="content">
  ...
  <div class="overview">
  <div class="dashboard-heading">Resume Penilaian Pergub 312</div>
  <div class="dashboard-content">
<?php
include "excomkoneksi.php";


$sqlA = "SELECT SUM(jumnjop) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB A' && kel90='1' ";
    	$result = mysql_query($sqlA) or die (mysql_error());
   	 $tA = mysql_fetch_array($result);

$sqlB = "SELECT SUM(jumnjop) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB B' &&  kel90='1' ";
    	$result = mysql_query($sqlB) or die (mysql_error());
   	 $tB = mysql_fetch_array($result);

$sqlC = "SELECT SUM(jumnjop) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB C' &&  kel90='1'";
    	$result = mysql_query($sqlC) or die (mysql_error());
   	 $tC = mysql_fetch_array($result);

$sqlD = "SELECT SUM(jumnjop) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB D' &&  kel90='1' ";
    	$result = mysql_query($sqlD) or die (mysql_error());
   	 $tD = mysql_fetch_array($result);

$sqlE = "SELECT SUM(jumnjop) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB E' &&  kel90='1' ";
    	$result = mysql_query($sqlE) or die (mysql_error());
   	 $tE = mysql_fetch_array($result);


	$hasil= mysql_query("select * from bast b inner join (select distinct nobast from akun)d on b.nobast=d.nobast inner join lokasidokumen l on b.nobast=l.nobastlokasi where   kel90='1'");
...
?>
          ...
          <table>
            <tr>
              ...
              <td> <a target="_blank" href="excompdflaporanakunA.php"><?php echo number_format($tA['total_nilaibast'],2);  ?></td>
            </tr>

            <tr>
              <td>Jumlah Nilai KIB B:</td>
              <td> <a target="_blank" href="excompdflaporanakunB.php"><?php echo number_format($tB['total_nilaibast'],2);  ?></td>
            </tr>
            <tr>
              <td>Jumlah Nilai KIB C:</td>
               <td> <a target="_blank" href="excompdflaporanakunC.php"><?php echo number_format($tC['total_nilaibast'],2);  ?></td>
            </tr>
            <tr>
              <td>Jumlah Nilai KIB D:</td>
               <td> <a target="_blank" href="excompdflaporanakunD.php"><?php echo number_format($tD['total_nilaibast'],2);  ?></td>
            </tr>
            <tr>
              <td>Jumlah Nilai KIB E:</td>
               <td> <a target="_blank" href="excompdflaporanakunE.php"><?php echo number_format($tE['total_nilaibast'],2);  ?></td>
            </tr>


            <tr>
              <td>Total Nilai :</td>
               <td> <a target="_blank" href="excompdflaporanakunABCDE.php"><?php echo (number_format(($tA['total_nilaibast'])+($tB['total_nilaibast'])+($tC['total_nilaibast'])+($tD['total_nilaibast'])+($tE['total_nilaibast']),2));  ?></td>
            </tr>
...
$sqlA = "SELECT SUM(nilaibast) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB A' &&  kel90='1' ";
    	$result = mysql_query($sqlA) or die (mysql_error());
   	 $tA = mysql_fetch_array($result);

$sqlB = "SELECT SUM(nilaibast) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB B' &&  kel90='1' ";
    	$result = mysql_query($sqlB) or die (mysql_error());
   	 $tB = mysql_fetch_array($result);

$sqlC = "SELECT SUM(nilaibast) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB C' &&  kel90='1' ";
    	$result = mysql_query($sqlC) or die (mysql_error());
   	 $tC = mysql_fetch_array($result);

$sqlD = "SELECT SUM(nilaibast) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB D' &&  kel90='1' ";
    	$result = mysql_query($sqlD) or die (mysql_error());
   	 $tD = mysql_fetch_array($result);

$sqlE = "SELECT SUM(nilaibast) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB E' &&  kel90='1' ";
    	$result = mysql_query($sqlE) or die (mysql_error());
   	 $tE = mysql_fetch_array($result);
...
?>
          ...
          <table>
            <tr>
              <td>Jumlah Nilai KIB A           :</td>
              <td> <a target="_blank" href="excompdflaporanakunABAST.php"><?php echo number_format($tA['total_nilaibast'],2);  ?></a></td>
            </tr>

            <tr>
              <td>Jumlah Nilai KIB B           :</td>
              <td> <a target="_blank" href="excompdflaporanakunBBAST.php"><?php echo number_format($tB['total_nilaibast'],2);  ?></a></td>
            </tr>
            <tr>
              <td>Jumlah Nilai KIB C           :</td>
               <td><a target="_blank" href="excompdflaporanakunCBAST.php"><?php echo number_format($tC['total_nilaibast'],2);  ?></a></td>
            </tr>
            <tr>
              <td>Jumlah Nilai KIB D           :</td>
               <td> <a target="_blank" href="excompdflaporanakunDBAST.php"><?php echo number_format($tD['total_nilaibast'],2);  ?></a></td>
            </tr>
            <tr>
              <td>Jumlah Nilai KIB E           :</td>
               <td><a target="_blank" href="excompdflaporanakunEBAST.php"><?php echo number_format($tE['total_nilaibast'],2);  ?></a></td>
            </tr>


            <tr>
              <td>Total Nilai                  :</td>
               <td> <a target="_blank" href="excompdflaporanakunABCDEBAST.php"><?php echo (number_format(($tA['total_nilaibast'])+($tB['total_nilaibast'])+($tC['total_nilaibast'])+($tD['total_nilaibast'])+($tE['total_nilaibast']),2));  ?></a></td>
            </tr>
  ...
  <div class="dashboard-content">
	...
	$query2 = mysql_query("select * from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB A' &&  kel90='1'") ;
	...
	<?php 
	 $no++;
		...
		$sql = "SELECT SUM(jumnjop) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB A' &&  kel90='1' ";
    	$result = mysql_query($sql) or die (mysql_error());
   	 $t = mysql_fetch_array($result);

		$sql2 = "SELECT SUM(nilaibast) AS total_nilaibast2 FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB A' &&  kel90='1' ";
  ...
  <div class="dashboard-content">
	  ...
	  <table class="list" id=datatable1 width="1400" border="1" >
		...
		<td class="center">Penilaian Kombinasi</td>
		<td class="center">Nilai BAST</td>
		<td class="center">Keterangan</td>
		<td class="center">Action</td>
              	</tr>
	...
	$query2 = mysql_query("select * from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB B' &&  kel90='1'") ;
	$no = 1;
	while ($data2 = mysql_fetch_array($query2)){
	...
	<?php 
	 $no++;
		...
		$sql = "SELECT SUM(jumnjop) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB B' &&  kel90='1' ";
    	$result = mysql_query($sql) or die (mysql_error());
   	 $t = mysql_fetch_array($result);

		$sql2 = "SELECT SUM(nilaibast) AS total_nilaibast2 FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB B' &&  kel90='1' ";
    	$result2 = mysql_query($sql2) or die (mysql_error());
   	 $t2 = mysql_fetch_array($result2);
	?>
  ...
  <div class="dashboard-content">
	...
	$query2 = mysql_query("select * from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB C' &&  kel90='1' ") ;
	...
	<?php 
	 $no++;
		...
		$sql = "SELECT SUM(jumnjop) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB C' &&  kel90='1' ";
    	$result = mysql_query($sql) or die (mysql_error());
   	 $t = mysql_fetch_array($result);

		$sql2 = "SELECT SUM(nilaibast) AS total_nilaibast2 FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB C' &&  kel90='1' ";
    	$result2 = mysql_query($sql2) or die (mysql_error());
   	 $t2 = mysql_fetch_array($result2);
  ...
  <div class="dashboard-content">
	...
	$query2 = mysql_query("select * from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB D' &&  kel90='1'") ;
	...
	?>
		...
		<td class="center"><?php print number_format  ($data2['nilaimix'],2); ?></td>
        	<td class="center"><?php print number_format  ($data2['nilaibast'],2); ?></td>
		<td class="right"><?php echo $data2['ketakun']; ?></td>		
		<td class="center"><a href="excomakunedit2bpk.php?id=<?php echo $data2['nobast']; ?>">Edit</a></td>
	</tr>
	...
	$sql = "SELECT SUM(jumnjop) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB D' &&  kel90='1' ";
    	$result = mysql_query($sql) or die (mysql_error());
   	 $t = mysql_fetch_array($result);

		$sql2 = "SELECT SUM(nilaibast) AS total_nilaibast2 FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB D' &&  kel90='1'";
    	$result2 = mysql_query($sql2) or die (mysql_error());
   	 $t2 = mysql_fetch_array($result2);
  ...
  <div class="dashboard-content">
	...
	$query2 = mysql_query("select * from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB E' &&  kel90='1'") ;
	...
	$sql = "SELECT SUM(jumnjop) AS total_nilaibast FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB E' &&  kel90='1' ";
    	$result = mysql_query($sql) or die (mysql_error());
   	 $t = mysql_fetch_array($result);

		$sql2 = "SELECT SUM(nilaibast) AS total_nilaibast2 FROM akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast where  kategoriaset='KIB E' &&  kel90='1' ";
    	$result2 = mysql_query($sql2) or die (mysql_error());
   	 $t2 = mysql_fetch_array($result2);

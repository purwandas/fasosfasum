...
$query = "select nobast, tglbast, pengembangbast,keterangan from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join lokasidokumen l on b.nobast=l.nobastlokasi where bpk357 ='0'  && mutasi ='1' && pulomas='1' &&  perihalbast!='mutasi2009' &&  perihalbast!='mutasi2010' order by nobast asc";

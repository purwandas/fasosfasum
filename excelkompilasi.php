...
$query = "SELECT * FROM akunhistory ah left join akun a on a.idperuntukan = ah.idperuntukan  inner join bast b on ah.nobast=b.nobast inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dataaset s on ah.idaset=s.idaset inner join peruntukan p on ah.idperuntukan=p.idperuntukan inner join lokasidokumen l on ah.nobast=l.nobastlokasi  order by ah.nobast" ;

...
<div id="header">
  <div class="div1">
    ...
    <ul class="left" style="display: none;">
      <li id="dashboard"><a href="#" class="top">Rekon LKPD</a></li>
...
<div id="content">
  ...
  <div class="dashboard-content">
	...
	$hasilbastlk2010= mysql_query("select *  from lokasidokumen where bpk357 ='1'");
...
$hasilbastlk201054= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where  bpk357 ='1'  && rekon129='0' && rekon54='1'");
	$totalbastlk201054 = mysql_num_rows($hasilbastlk201054);

$hasilbastlk2010163= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where   bpk357 ='1'  && rekon129='0' && rekon54='0' && rekon163='1'");
	$totalbastlk2010163 = mysql_num_rows($hasilbastlk2010163);

$hasilbastlk2010101= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where  bpk357 ='1'  && rekon129='0' && rekon54='0' && rekon163='0' && rekon101='1'");
	$totalbastlk2010101 = mysql_num_rows($hasilbastlk2010101);
	
$hasilbastlk2010mutasi= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where bpk357 ='1' && mutasi='1' && perihalbast!='mutasi2009' && perihalbast!='mutasi2010' ");
	$totalbastlk2010mutasi = mysql_num_rows($hasilbastlk2010mutasi);


$hasilbastlk20102009= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where  bpk357 ='1'   && rekon129='0' && rekon54='0' && rekon163='0' && rekon101='0' && balaikota='0' &&  perihalbast='mutasi2009'");
	$totalbastlk20102009 = mysql_num_rows($hasilbastlk20102009);

$hasilbastlk20102010= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where  bpk357 ='1'   && rekon129='0' && rekon54='0' && rekon163='0' && rekon101='0' && balaikota='0'  && balaikota='0' && perihalbast='mutasi2010'");
	$totalbastlk20102010 = mysql_num_rows($hasilbastlk20102010);

$hasilbastlk2010tambah= mysql_query("select * from lokasidokumen l inner join bast b on l.nobastlokasi=b.nobast where mutasi='0' && bpk357 ='1'  && pulomas='0' &&  rekon101='0' && rekon129='0' && rekon54='0' && rekon163='0'  && tp3w='0' && dtr='0' && balaikota='0'");
	...
	?>
          ...
          <table>
            <tr>
              <td>Total BAST LK2010:</td>
              <td><a target="_blank" href="pdfbpk.php"><?php echo $totalbastlk2010 ?></a></td>
            </tr>

            <tr>
              <td>Jumlah BAST LK2010-SIPPT :</td>
              <td><a target="_blank" href="pdfbpksippt.php"><?php echo $totalbastlk2010sippt ?></a></td>
            </tr>

            <tr>
              <td>Jumlah BAST LK2010-NONSIPPT :</td>
              <td><a target="_blank" href="pdfbpknonsippt.php"><?php echo $totalbastlk2010nonsippt ?></a></td>
            </tr>
         
            <tr>
              <td>Jumlah LK2010-129 :</td>
              <td><a target="_blank" href="pdfbpk129.php"><?php echo $totalbastlk2010129 ?></a></td>
            </tr>

             <tr>
              <td>Jumlah LK2010-54 :</td>
              <td><a target="_blank" href="pdfbpk54.php"><?php echo $totalbastlk201054 ?></a></td>
            </tr>

             <tr>
              <td>Jumlah LK2010-163 :</td>
              <td><a target="_blank" href="pdfbpk163.php"><?php echo $totalbastlk2010163 ?></a></td>
            </tr>
            <tr>
              <td>Jumlah LK2010-101 :</td>
              <td><a target="_blank" href="pdfbpk101.php"><?php echo $totalbastlk2010101 ?></a></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><a target="_blank" href="pdfbpk2011.php"><?php echo $totalbastlk2010mutasi ?></a></td>
            </tr>


            <tr>
              <td>Jumlah Penambahan :</td>
              <td><?php echo $totalbastlk2010tambah ?></td>
            </tr>
...
if(isset($_REQUEST['submit2'])) {
	...
	$query = mysql_query("select * from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dokumenacuan c on d.idkategori=c.idkategori inner join lokasidokumen l on b.nobast=l.nobastlokasi where bpk357='1' && (nobast like '%$term%' or pengembangbast like '%$term%'  or jenisdokumen like '%$term%')");
}else

$query = mysql_query("select * from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dokumenacuan c on d.idkategori=c.idkategori inner join lokasidokumen l on b.nobast=l.nobastlokasi where bpk357='1' order by nobast asc");
	$no = 1;

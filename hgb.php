...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" /> Data HGB</h1>
    </div>
    ...
    <div class="content">
      ...
      <div class="latest">
        <div class="dashboard-heading">Data HGB</div>
        <div class="dashboard-content">
          ...
          <table class="list" cellpadding="5" cellspacing="5">
            ...
            $query = mysql_query("select * from bast b inner join dataaset d on b.nobast=d.nobastaset inner join peruntukan p on d.nobastaset=p.nobast where jenissertifikat='HGB'");
            ...
            while ($data = mysql_fetch_array($query)) {
             ...
             <tbody>
               <tr>
                 ...
                 <td class="left"><?php echo $data['jenissertifikat']; ?></td>
                 <td class="left"><?php echo $data['luassertifikat']; ?></td>

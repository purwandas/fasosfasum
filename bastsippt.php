...
<div id="header">
  <div class="div1">
    ...
    <ul class="left" style="display: none;">
      <li id="dashboard"><a href="#" class="top">BAST SIPPT</a></li>
...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" /> BAST SIPPT</h1>
...
<a target="_blank" href="excelbastsippt.php">
Data per BAST

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastsippt2.php">
Data Detail

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastsippt129.php">
Kel.129

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastsippt54.php">
Kel.54

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastsippt163.php">
Kel.163

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastsippt101.php">
Kel.101

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastsippt2009.php">
kel.2009


<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastsippt2010.php">
Kel.2010

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastsipptmutasi.php">
Kel.mutasi 2011

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastsippttambah.php">
Kel.140 Penambah
  ...
  <div class="latest">
  <div class="dashboard-heading">Data BAST SIPPT</div>

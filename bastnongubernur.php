...
<div id="header">
  <div class="div1">
    ...
    <ul class="left" style="display: none;">
      <li id="dashboard"><a href="#" class="top">BAST NonGubernur</a></li>
...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" /> BAST Non Gubernur</h1>
    </div>
  ...
  <div class="latest">
  <div class="dashboard-heading">Data BAST Non Gubernur</div>
...
<?php
	...
	$query = mysql_query("select * from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dokumenacuan c on d.idkategori=c.idkategori where keterangan like '%wali%' or keterangan like '%sek%' or keterangan like '%biro%'");

...
<input type="hidden" name="id" value="<?php echo $idaset; ?>" />
	...
	<td><a href="akuntingentrynilaibast.php?id=<?php echo $data['nobastaset']; ?>">Input Nila Akunting klik disini..</a></td>
	</tr>
	</table>
	<head>
	<script>
	...
	function tambah1(){
   	...
   	td2.innerHTML="<select name='jenis[]'><option>Tanah</option><option>Non-Tanah</option></select>"; 
    	td3.innerHTML="<input type='text' name='luas[]' onkeypress="return isNumberKey(event)">";
...
<br>
	<div style="width:1132px; height:200px;overflow:auto;">  
	...
	<td><input type='text' name='luas[]' onkeypress="return isNumberKey(event)"></td>

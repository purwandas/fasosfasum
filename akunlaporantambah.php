...
<body>
  <div id="container">
    ...
    <div id="content">
      ...
      <div class="box">
        <div class="heading">
          <h1><img src="view/image/home.png" alt="" />Laporan Penilaian BAST Penambah</h1>
          <P align=right><span>
           ...
           <div class="content">
            ...
            <div class="overview">
              <div class="dashboard-heading">Resume Penilaian Pergub 132 BAST Penambah</div>
              <div class="dashboard-content">
                ...
                $totalrowlkpdtambah = mysql_num_rows($hasil);
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td> <?php echo $totalrowlkpdtambah;  ?></td>
                  </tr>
            ...
            <div class="statistic">
              <div class="dashboard-heading">Resume Nilai BAST Penambah</div>
              <div class="dashboard-content">
                <?php
                include "koneksi.php";

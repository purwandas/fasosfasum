																		...
																		<tbody>
																			...
																			while ($data2 = mysql_fetch_array($query2)){
																				...
																				<tr>
																					...
																					<td class="center"><a href="akunedit2bpk.php?id=<?php echo $data2['nobast']; ?>">Edit</a>.|.<a href="akunhapus.php?id=<?php echo $data2['nobast']; ?>" onClick="return konfirmasi()">Hapus</a></td>
																				</tr>

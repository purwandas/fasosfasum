...
$query = "select nobastlokasi, deskripsi, volume, satuan, jumnjop from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB C' ";
...
$pdf->Cell(31,1,'LAPORAN PENILAIAN EXCOM-PERGUB - KIB C','LRTB',0,'C');

...
<div id="header">
  <div class="div1">
    ...
    <ul class="left" style="display: none;">
      <li id="dashboard"><a href="#" class="top">Dok.Acuan</a></li>
...
<div id="content">
  <div class="breadcrumb">
    ...
    <div class="content">
      <div class="overview">
        <div class="dashboard-heading">Kategori Dokumen</div>
	...
	<thead>
    	<tr>
                ...
                <td class="center">JENIS DOKUMEN</td>
    ...
    <?php
        include "koneksi.php";
	$query = mysql_query("select * from dokumenacuan");
	...
	<tbody>
    	<tr>
        	...
        	<td class="center"><?php echo $data['idkategori']; ?></td>
	...
	?>
      ...
      <div class="statistic">
		...
		<table>
                <tr>
        	<td>Id </td>           
                <td><input type="text" name="id" maxlength="20" required="required" disabled/ /></td>
                </tr>

                <tr>
              	<td>Jenis Dokumen </td>
                <td><input type="text" name="jenisdokumen" maxlength="40" required="required" /></td>
                </tr>
...
$query = mysql_query("insert into dokumenacuan values('', '$jenisdokumen')") or die(mysql_error());

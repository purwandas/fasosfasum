...
$pdf->Cell(31,1,'LAPORAN PENILAIAN PERGUB 132 BAST PENAMBAHAN - KIB D','LRTB',0,'C');
...
$pdf->Cell(9,1,'PERUNTUKAN','LRTB',0,'C');

$pdf->Cell(3,1,'VOLUME','LRTB',0,'C');
$pdf->Cell(2,1,'SATUAN','LRTB',0,'C');
$pdf->Cell(4,1,'PENGALI','LRTB',0,'C');
$pdf->Cell(4,1,'JUMLAH(Rp)','LRTB',0,'C');
...
$pdf->Cell(8,1,$cell[$j][0],'LBTR',0,'L');
 ...
 $pdf->Cell(9,1,$cell[$j][1],'LBTR',0,'L');

 $pdf->Cell(3,1,$cell[$j][2],'LBTR',0,'C');

 $pdf->Cell(2,1,$cell[$j][3],'LBTR',0,'C');

$pdf->Cell(4,1,$cell[$j][4],'LBTR',0,'R');

$pdf->Cell(4,1,$cell[$j][5],'LBTR',0,'R');
...
$pdf->Cell(31,1,'TOTAL : Rp. 2,762,771,941,976.46','LRTB',0,'R');

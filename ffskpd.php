...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" /> Data Fasos Fasum vs SKPD </h1>
	<P align=right><span>
	<a target="_blank" href="excelskpd.php" ></li>
	<img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
	<a target="_blank" href="excelskpd.php">
	Print SKPD
	</a></span>
  ...
  <div class="latest">
  <div class="dashboard-heading">Fasos Fasum yang telah masuk SKPD</div>
...
$query = mysql_query("SELECT * FROM skpd a inner join akun n on a.idperuntukan=n.idperuntukan inner join bast b on a.nobast=b.nobast  inner join dataaset s on a.idaset=s.idaset inner join peruntukan p on a.idperuntukan=p.idperuntukan  ");
	...
	?>
		...
		<td class="center"><a href="#">Edit</a>.|.<a href="skpdhapus.php?id=<?php echo $data['idperuntukan']; ?>" onClick="return konfirmasi()">Hapus</a></td>

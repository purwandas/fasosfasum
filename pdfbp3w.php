...
$query = "select nobast,tglbast,pengembangbast,keterangan, wilayah from bast b inner join (select distinct nobastaset, wilayah from dataaset)d on b.nobast=d.nobastaset inner join lokasidokumen l on b.nobast=l.nobastlokasi where bpk357 ='0' && pulomas='0' && tp3w='1' order by nobast asc";

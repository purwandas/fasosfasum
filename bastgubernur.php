...
<div id="content">
  <div class="breadcrumb">
        <a href="home.php">Home</a>
              ...
              <div class="box">
    <div class="heading">
      <h1><img src="view/image/home.png" alt="" /> BAST Gubernur</h1>
...
<a target="_blank" href="excelbastgub.php">
BAST Gubernur

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastgub129.php">
BAST Gubernur 129

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastgub54.php">
BAST Gubernur 54

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastgub163.php">
BAST Gubernur 163

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastgub101.php">
BAST Gubernur 101

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastgub2009.php">
BAST Gubernur 2009

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastgub2010.php">
BAST Gubernur 2010

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastgubmutasi.php">
BAST Gubernur Mutasi 2011

<a><img alt=" " src="view/image/excel.jpg" border=0></a>&nbsp;
<a target="_blank" href="excelbastgubtambah.php">
BAST Gubernur 140 Penambah


</a></span></P>

  <div class="latest">
  <div class="dashboard-heading">Data BAST Gubernur</div>
...
<?php
	...
	$query = mysql_query("select * from bast b inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join dokumenacuan c on d.idkategori=c.idkategori where keterangan like '%Gubernur%'");

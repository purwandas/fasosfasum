...
$query = "select nobastlokasi, deskripsi, volume, satuan, nilaimix from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kategoriaset='KIB D' && kel90='1'";
...
$pdf->Cell(31,1,'LAPORAN PENILAIAN KOMBINASI EXCOM - KIB D','LRTB',0,'C');
...
$pdf->Cell(31,1,'TOTAL : Rp. 208,500,000.00','LRTB',0,'R');

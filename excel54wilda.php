...
$query = "SELECT * FROM bast b inner join (select distinct nobast, totmix from akun)a on a.nobast=b.nobast inner join detaildokacuan d on b.nodokacuan=d.nodokacuan  inner join lokasidokumen l on a.nobast=l.nobastlokasi where b.keterangan like '%wilda%' && 

...
$query = "SELECT * FROM bast b inner join kelompok l on b.nobast=l.nobastkelompok inner join detaildokacuan d on b.nodokacuan=d.nodokacuan inner join (select distinct nobastaset, alamataset, kelurahan, kecamatan, wilayah from dataaset)s on b.nobast=s.nobastaset  


where  fisiknol='1' order by nobast";

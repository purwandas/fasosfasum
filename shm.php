...
<div id="content">
  ...
  <div class="latest">
  <div class="dashboard-heading">Data SHM</div>
...
<?php
	...
	$query = mysql_query("select * from bast b inner join dataaset d on b.nobast=d.nobastaset inner join peruntukan p on d.nobastaset=p.nobast where jenissertifikat='SHM'");

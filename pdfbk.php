...
$query = "select nobast,tglbast,pengembangbast,keterangan, wilayah from bast b inner join (select distinct nobastaset, wilayah from dataaset)d on b.nobast=d.nobastaset inner join lokasidokumen l on b.nobast=l.nobastlokasi where  mutasi ='0' && bpk357 ='0' && pulomas='0' && tp3w='0' && dtr='0' && balaikota = '1' order by nobast asc";
...
$pdf->Cell(31,1,'DATA BP3W','LRTB',0,'C');

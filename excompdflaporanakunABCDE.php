...
$query = "select nobastlokasi, deskripsi, volume, satuan, jumnjop from akun a inner join lokasidokumen l on a.nobast=l.nobastlokasi inner join bast b on l.nobastlokasi=b.nobast inner join peruntukan p on a.idperuntukan=p.idperuntukan where  kel90='1'";
...
$pdf->Cell(31,1,'LAPORAN PENILAIAN EXCOM - KIB A,B,C,D & E','LRTB',0,'C');
...
$pdf->Cell(31,1,'TOTAL : Rp. 181,399,796,269.99','LRTB',0,'R');
